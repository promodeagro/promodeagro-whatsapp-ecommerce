...
const items = [
    ...
    { name: 'Orange', price: '1.00', quantity: '2' }
];

generateBillImage(items).then(pdfBytes => {
    // Save the PDF to a file
    const fs = require('fs');
    fs.writeFileSync('bill.pdf', pdfBytes);
    console.log('Bill PDF generated and saved as bill.pdf');
});
